...
from tests.from_export.file_a export Widget, Gadget

from tests.from_export.file_b export *

from tests.from_export.file_c export (a,
    b,
   c,
d
)
...
from tests.from_export.file_d export *