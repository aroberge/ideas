...
.. admonition:: Summary
    ...
    Using a very simple transformation during the tokenizing phase,
...
Here is another equation, taken from a class I taught :text-strike:`last week`
many years ago.
...
one (except perhaps with an additional `*` before the second `cos` function or,
on paper, using slightly larger parentheses in some places.)


.. admonition:: Quote from Guido van Rossum
    ...
    comes in.  ...
    `Source <https://mail.python.org/archives/list/python-ideas@python.org/message/52DLME5DKNZYFEETCTRENRNKWJ2B4DD5/>`_
...
Here's a simple example done as an interactive session.
